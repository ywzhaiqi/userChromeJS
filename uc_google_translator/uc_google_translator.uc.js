...
var zol_bod_google_translator = {
  ...
  refreshInformation: function(whatToTranslate) {
     if (this.isValidTextLength(whatToTranslate)) {
        ...
        function infoReceived() {
           ...
           if (whatToTranslate[0]==" ") { var kezdospace=" "; } else { var kezdospace=""; }
           if (whatToTranslate[whatToTranslate.length-1]==" ") { var vegespace=" "; } else { var vegespace=""; }
  ...
  show: function(res){
        ...
        setTimeout(function(){zol_bod_google_translator.sizeChange();},0);
        this._timer = setTimeout(function(){popup.hidePopup();},30000);//最大30秒で消す
  },

...
var SITEINFO=[
    ...
    {siteName: '百度新闻',
        ...
        siteExample: 'http://news.baidu.com/ns?cl=2&rn=20&tn=news&word=wifi&ie=utf-8',
        nextLink: '//a[@class="next"]',
        autopager:{
            pageElement: '//div[@id="r"] | //div[@class="pg"]',
        }
    },
    {
        siteName: '百度空间',
	...
	{siteName:'OperaChina',
		...
		nextLink:'auto;',
		autopager:{
			pageElement:'//body/table | //article[@id][contains(@class, "post")]',
		}
	},
	...
	{siteName:'Discuz X2.5修复',
		url:/^http?:\/\/(bbs.gfan|bbs.xda|bbs.xiaomi|www.diypda|f.ppxclub)\.(com|cn)/i,
		nextLink:'auto;',
		autopager:{
			pageElement:'//div[@id="threadlist"] | //div[@id="postlist"]',
		}
    ...
    {siteName: '3dm论坛',
        ...
        exampleUrl: 'http://bbs.3dmgame.com/AssassinsCreed',
    },
	{siteName:'猴岛论坛',
    ...
    {siteName: '天涯论坛_帖子列表',
        ...
        exampleUrl: 'http://bbs.tianya.cn/list.jsp?item=feeling&nextid=1369907818000'
    },
	{siteName:'天涯论坛帖子',
    ...
    {siteName: 'BookLink.Me:最有爱的小说搜索引擎',
        ...
        exampleUrl: 'http://booklink.me/charpter.php?site_id=1&book_id=2643379',
    },
    ...
    {siteName: '抽屉新热榜',
        ...
        exampleUrl: 'http://dig.chouti.com/'
    },
    {siteName: '糗事百科',
    ...
    {siteName: "Stack Overflow, Super User, Server Fault, Stack Apps",
